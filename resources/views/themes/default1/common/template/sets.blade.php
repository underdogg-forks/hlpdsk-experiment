...
<div class="card card-light">
    <div class="card-header">
        <h3 class="card-title">{{ trans('lang.list_of_templates_sets') }}</h3>
    ...
    @csrf
                        ...
                        ?>
                        <button class="btn btn-danger btn-sm {!! $dis !!}" data-toggle="modal" data-target="#delete{{$set->id}}">{{ trans('lang.delete') }}</button>
