        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('parent_topic') ? 'has-error' : '' }}">
                    ...
                    {!!Form::select('parent_topic', [''=>trans('lang.select_a_parent_topic'),trans('lang.help_topic')=>$topics->pluck('topic','id')->toArray()],null,['class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('custom_form') ? 'has-error' : '' }}">
                    ...
                    {!!Form::select('custom_form', [''=>trans('lang.select_a_form'),trans('lang.custom_form')=>$forms->pluck('formname','id')->toArray()],null,['class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('department') ? 'has-error' : '' }}">
                    ...
                    {!!Form::select('department', [''=>trans('lang.select_a_department'),trans('lang.departments')=>$departments->pluck('name','id')->toArray()],null,['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('sla_plan') ? 'has-error' : '' }}">
                    ...
                    {!!Form::select('sla_plan', [''=>trans('lang.select_a_sla_plan'),trans('lang.sla_plans')=>$slas->pluck('name','id')->toArray()],null,['class' => 'form-control']) !!}
                </div>
            </div>
