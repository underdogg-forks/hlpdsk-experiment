...
<form class="form-horizontal" action="{!! URL::route('workflow.store') !!}" method="POST" id="form">
    ...
    <div class="card card-light">
        ...
        <div class="card-header">
            <h3 class="card-title">{{ trans('lang.create_workflow') }}</h3>
        </div>
        <!-- /.box-header -->
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-6 {!! $errors->has('status') ? 'has-error' : '' !!}">
                    ...
                    <div>
                        <input type="radio" id="inputEmail2" name="status" value="1" >&nbsp;&nbsp;{{ trans('lang.active') }}&nbsp;&nbsp;
                        <input type="radio" id="inputEmail1" name="status" value="0" checked>&nbsp;&nbsp;{{ trans('lang.inactive') }}&nbsp;&nbsp;
                    </div>
                </div>
            </div>
