...
<div class="card card-light">
    <div class="card-header">
        <h3 class="card-title">{{ trans('lang.company_settings') }}</h3>
    </div>
            ...
            <div class="col-sm-10">
                <div id="logo-display" style="display: block;">
                    <div class="row">
                        ...
                        @if($companys->logo != null)
                        <div class="col-md-3 image" data-content="{{ trans('lang.click-delete') }}">
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".image").on("click", function() {
            $('#myModal').modal('show');
            $("#myModalLabel").html("{{ trans('lang.delete-logo') }}");
            $(".yes").html("{{ trans('lang.yes') }}");
            $(".no").html("{{ trans('lang.cancel') }}");
            $("#custom-alert-body").html("{{ trans('lang.confirm') }}");
        });
