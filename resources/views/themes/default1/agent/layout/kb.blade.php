        ...
        <div class="wrapper" id="RefreshAssign">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                @endif
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="{{url('profile')}}" class="btn btn-default btn-flat">{{ trans('lang.profile') }}</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="{{ url('/auth/logout') }}" class="btn btn-default btn-flat">{{ trans('lang.signout') }}</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview @yield('widget')">
                            <a href="#">
                                <i class="fa  fa-th"></i> <span>{{ trans('lang.widgets') }}</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                                    <ul class="treeview-menu">
                                        <li @yield('footer1')><a href="{{url('create-footer')}}"><i class="fa fa-circle-o"></i> {{ trans('lang.footer1') }}</a></li>
                                        <li @yield('footer2')><a href="{{url('create-footer2')}}"><i class="fa fa-circle-o"></i> {{ trans('lang.footer2') }}</a></li>
                                        <li @yield('footer3')><a href="{{url('create-footer3')}}"><i class="fa fa-circle-o"></i> {{ trans('lang.footer3') }}</a></li>
                                        <li @yield('footer4')><a href="{{url('create-footer4')}}"><i class="fa fa-circle-o"></i> {{ trans('lang.footer4') }}</a></li>
                                        <li @yield('side1')><a href="{{url('side1')}}"><i class="fa fa-circle-o"></i> {{ trans('lang.sidewidget1') }}</a></li>
                                        <li @yield('side2')><a href="{{url('side2')}}"><i class="fa fa-circle-o"></i> {{ trans('lang.sidewidget2') }}</a></li>
            ...
            <footer class="main-footer">
                <div class="pull-right hidden-xs">
                    <b>{{ trans('lang.version') }}</b> {{$settings->version}}
                </div>
