...
<div class="card card-light">
    <div class="card-header">
        <h3 class="card-title">{{ trans('lang.inbox') }} </h3> &nbsp;<small id="title_refresh">({!! $tickets !!} {{ trans('lang.tickets') }})</small>
    </div><!-- /.box-header -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-primary yes" data-dismiss="modal">{{ trans('lang.yes') }}</button>
            </div>
        </div>
    </div>
</div>
