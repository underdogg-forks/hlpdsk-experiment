...
<div class="modal fade" id="MergeTickets">
    ...
    @method('PATCH')
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="select-merge-parent"  name='p_id' data-placeholder="{{ trans('lang.select_tickets') }}" style="width: 100%;"><option value=""> {{trans('lang.optional')}}</option></select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
