...
{{--<div class="site-hero clearfix">--}}
    <ol class="breadcrumb float-sm-right ">
        ...
        <li><a href="{!! URL::route('form') !!}">{{ trans('lang.submit_a_ticket') }}</a></li>
    </ol>
</div>
@stop
<!-- /breadcrumbs -->
            ...
            <div id="form-border" class="comment-respond form-border" style="background : #fff">
                ...
                <section id="section-categories">
                    ...
                    <h2 class="section-title h4 clearfix mb-0">
                        ...
                        <i class="line" style="border-color: rgb(0, 154, 186);"></i>{{ trans('lang.submit_a_ticket') }}
                    </h2>
...
//                            ?><!---->
    ...
    @endforeach
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            {{ trans('lang.max') }}. {!! $max_size_in_actual !!}
                        </div>
                        {{-- Event fire --}}
                        ...
                        <div id="ss" class="xs-md-6 form-group {{ $errors->has('') ? 'has-error' : '' }}"> </div>
                                <div class="col-md-12 form-group">
                                    {!! Form::button('<i class="fas fa-save"></i> ' . trans('lang.submit'), ['type'=>'submit', 'class'=>'btn btn-info float-right', 'style'=>'style="border-color: rgb(0, 192, 239); background-color: rgb(0, 154, 186); color: white;', 'onclick' => 'this.disabled=true;this.innerHTML="Sending, please wait...";this.form.submit();', 'data-v-fce8d630']) !!}
                                </div>
                            <div class="col-md-12" id="response"> </div>
                        <div id="ss" class="xs-md-6 form-group {{ $errors->has('') ? 'has-error' : '' }}"> </div>
